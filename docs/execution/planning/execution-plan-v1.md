...
**Release gate:** `docs/execution/golden-loop-test.md` (pinned to v0.2.3) —
the golden loop test is the final release gate. Every public release must
pass all 12 phases before shipping.
