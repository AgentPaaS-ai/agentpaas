...
### v0.1.2 (Block 19 — AgentGateway Policy Integration)
Wire up agentgateway v1.3.0 native features. Spec:
`docs/execution/blocks/b19-summary.md`

**P0 — Gateway-Level Enforcement:**
- Gateway credential injection (move from harness to gateway —
  `CompileCredentialRules()` wired into gateway config)
