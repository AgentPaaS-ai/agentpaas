...
#   2. Every binary reports 0.4.2-dev (dev) or the expected release version.
#   3. The harness-linux cross-compile contains the correct version string.
#
# Usage:
#   ./scripts/check-release-versions.sh              # check dev build (0.4.2-dev)
#   ./scripts/check-release-versions.sh 0.4.2         # check release build
#
# Exit codes:
