...
#   2. Every binary reports 0.3.5-dev (dev) or the expected release version.
#   3. The harness-linux cross-compile contains the correct version string.
#
# Usage:
#   ./scripts/check-release-versions.sh              # check dev build (0.3.5-dev)
#   ./scripts/check-release-versions.sh 0.3.5         # check release build
#
# Exit codes:
